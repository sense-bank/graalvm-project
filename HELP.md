...
* The original package name 'com.test.graalvm-project' is invalid and this project uses 'com.test.graalvmproject' instead.
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.0.8/maven-plugin/reference/htmlsingle/#aot)
